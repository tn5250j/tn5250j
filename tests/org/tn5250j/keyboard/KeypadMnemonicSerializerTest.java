...
public class KeypadMnemonicSerializerTest {

  private KeypadMnemonicSerializer serializer;

  @Before
  public void setUp() throws Exception {
    serializer = new KeypadMnemonicSerializer();
  }

  @Test
  public void mnemonics_are_serialized_as_comma_separated_string() throws Exception {
    String actual = serializer.serialize(new KeypadMnemonic[]{CLEAR, ATTN, COPY});
  ...
  public void serializer_is_empty_array_safe() throws Exception {
    String actual = serializer.serialize(new KeypadMnemonic[0]);
  ...
  public void mnemonics_are_deserialized_from_comma_separated_string() throws Exception {
    KeypadMnemonic[] actual = serializer.deserialize("[clear], [attn] ,[copy]");
  ...
  public void deserializer_is_null_safe() throws Exception {
    KeypadMnemonic[] actual = serializer.deserialize(null);
  ...
  public void deserializer_is_safe_with_empty_string() throws Exception {
    KeypadMnemonic[] actual = serializer.deserialize("");
  ...
  public void deserializer_ignores_unknown_values() throws Exception {
    KeypadMnemonic[] actual = serializer.deserialize("[clear],,[foobar],[attn]");
