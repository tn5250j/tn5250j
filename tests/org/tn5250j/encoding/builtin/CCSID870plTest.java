...
public class CCSID870plTest {
	...
	public void testBoth() {
		final ICodePage cp = CharMappings.getCodePage("870-pl");
	...
	public void testNewAndToolbox() {
		final ICodePage cp = ToolboxCodePageProvider.getCodePage("870");
		final CCSID870 cpex = new CCSID870();
		cpex.init();
		assertNotNull("At least an ASCII Codepage should be available.", cpex);

		// According to
		// http://www-01.ibm.com/software/globalization/cp/cp00870.jsp
	...
	public void testOldAndToolbox() {
		final ICodePage cp = ToolboxCodePageProvider.getCodePage("870");
		final ICodePage cpex = CharMappings.getCodePage("870-pl");
		assertNotNull("At least an ASCII Codepage should be available.", cpex);
