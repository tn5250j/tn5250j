...
public class CCSID1025Test {
	...
	public void testOldConverter1025() {
		...
		ICodePage cp = CharMappings.getCodePage("1025-r");
	...
	public void testBoth() {
		final ICodePage cp = CharMappings.getCodePage("1025-r");
	...
	public void testNewAndToolbox() {
		final ICodePage cp = ToolboxCodePageProvider.getCodePage("1025");
		final CCSID1025 cpex = new CCSID1025();
		cpex.init();
		assertNotNull("At least an ASCII Codepage should be available.", cpex);

		// According to
		// http://www-01.ibm.com/software/globalization/cp/cp01025.jsp
	...
	public void testOldAndToolbox() {
		final ICodePage cp = ToolboxCodePageProvider.getCodePage("1025");
		final ICodePage cpex = CharMappings.getCodePage("1025");
		assertNotNull("At least an ASCII Codepage should be available.", cpex);
