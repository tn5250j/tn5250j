 ...
 * of the 'old' CCSID1147<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID1147 {
	...
	private CodePage cp;
	private CCSID1147 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("1147");
		cpex = new CCSID1147();
		cpex.init();
