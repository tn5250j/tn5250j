...
public class CCSID1147Test {
	...
	public void testOldConverter1147() {
		...
		CodePage cp = CharMappings.getCodePage("1147");
	...
	public void testBoth() {
		final CodePage cp = CharMappings.getCodePage("1147");
	...
	public void testNewAndToolbox() {
		final CodePage cp = ToolboxCodePageProvider.getCodePage("1147");
		final CCSID1147 cpex = new CCSID1147();
		cpex.init();
		assertNotNull("At least an ASCII Codepage should be available.", cpex);

		// According to
		// http://www-01.ibm.com/software/globalization/cp/cp01147.jsp
	...
	public void testOldAndToolbox() {
		final CodePage cp = ToolboxCodePageProvider.getCodePage("1147");
		final CodePage cpex = CharMappings.getCodePage("1147");
		assertNotNull("At least an ASCII Codepage should be available.", cpex);
