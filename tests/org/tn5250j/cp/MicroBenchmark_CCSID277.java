 ...
 * of the 'old' CCSID277<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID277 {
	...
	private CodePage cp;
	private CCSID277 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("277");
		cpex = new CCSID277();
		cpex.init();
