 ...
 * of the 'old' CCSID1026<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID1026 {
	...
	private CodePage cp;
	private CCSID1026 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("1026");
		cpex = new CCSID1026();
		cpex.init();
