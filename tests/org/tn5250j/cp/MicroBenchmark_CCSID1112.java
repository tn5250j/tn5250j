 ...
 * of the 'old' CCSID1112<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID1112 {
	...
	private CodePage cp;
	private CCSID1112 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("1112");
		cpex = new CCSID1112();
		cpex.init();
