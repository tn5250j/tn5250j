 ...
 * of the 'old' CCSID1140<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID1140 {
	...
	private CodePage cp;
	private CCSID1140 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("1140");
		cpex = new CCSID1140();
		cpex.init();
