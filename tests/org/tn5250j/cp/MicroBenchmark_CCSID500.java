 ...
 * of the 'old' CCSID500<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID500 {
	...
	private CodePage cp;
	private CCSID500 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("500");
		cpex = new CCSID500();
		cpex.init();
