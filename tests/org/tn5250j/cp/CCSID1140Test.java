...
public class CCSID1140Test {
	...
	public void testOldConverter1140() {
		...
		CodePage cp = CharMappings.getCodePage("1140");
	...
	public void testBoth() {
		final CodePage cp = CharMappings.getCodePage("1140");
	...
	public void testNewAndToolbox() {
		final CodePage cp = ToolboxCodePageProvider.getCodePage("1140");
		final CCSID1140 cpex = new CCSID1140();
		cpex.init();
		assertNotNull("At least an ASCII Codepage should be available.", cpex);

		// According to
		// http://www-01.ibm.com/software/globalization/cp/cp01140.jsp
	...
	public void testOldAndToolbox() {
		final CodePage cp = ToolboxCodePageProvider.getCodePage("1140");
		final CodePage cpex = CharMappings.getCodePage("1140");
		assertNotNull("At least an ASCII Codepage should be available.", cpex);
