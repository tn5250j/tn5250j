...
public class CCSID1112Test {
	...
	public void testOldConverter1112() {
		...
		CodePage cp = CharMappings.getCodePage("1112");
	...
	public void testBoth() {
		final CodePage cp = CharMappings.getCodePage("1112");
	...
	public void testNewAndToolbox() {
		final CodePage cp = ToolboxCodePageProvider.getCodePage("1112");
		final CCSID1112 cpex = new CCSID1112();
		cpex.init();
		assertNotNull("At least an ASCII Codepage should be available.", cpex);

		// According to
		// http://www-01.ibm.com/software/globalization/cp/cp01112.jsp
	...
	public void testOldAndToolbox() {
		final CodePage cp = ToolboxCodePageProvider.getCodePage("1112");
		final CodePage cpex = CharMappings.getCodePage("1112");
		assertNotNull("At least an ASCII Codepage should be available.", cpex);
