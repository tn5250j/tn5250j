...
/**
 * Testing the correctness of {@link CCSID285} and comparing with existing implementation.
 *
 * @author master_jaf
 */
public class CCSID285Test {
	...
	public void testOldConverter285() {
		...
		CodePage cp = CharMappings.getCodePage("285");
	...
	public void testBoth() {
		final CodePage cp = CharMappings.getCodePage("285");
