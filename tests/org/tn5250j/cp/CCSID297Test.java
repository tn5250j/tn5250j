...
/**
 * Testing the correctness of {@link CCSID297} and comparing with existing implementation.
 *
 * @author master_jaf
 */
public class CCSID297Test {
	...
	public void testOldConverter297() {
		...
		CodePage cp = CharMappings.getCodePage("297");
	...
	public void testBoth() {
		final CodePage cp = CharMappings.getCodePage("297");
