 ...
 * of the 'old' CCSID284<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID284 {
	...
	private CodePage cp;
	private CCSID284 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("284");
		cpex = new CCSID284();
		cpex.init();
