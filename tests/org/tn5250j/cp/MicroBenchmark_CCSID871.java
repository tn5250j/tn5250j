 ...
 * of the 'old' CCSID871<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID871 {
	...
	private CodePage cp;
	private CCSID871 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("871");
		cpex = new CCSID871();
		cpex.init();
