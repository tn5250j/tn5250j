...
/**
 * Testing the correctness of {@link CCSID37} and comparing with existing implementation.
 *
 * @author master_jaf
 */
public class CCSID37Test {
	...
	public void testOldConverter37() {
		...
		CodePage cp = CharMappings.getCodePage("37");
	...
	public void testBoth() {
		final CodePage cp = CharMappings.getCodePage("37");
