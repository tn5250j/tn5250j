...
public class CCSID1026Test {
	...
	public void testOldConverter1026() {
		...
		CodePage cp = CharMappings.getCodePage("1026");
	...
	public void testBoth() {
		final CodePage cp = CharMappings.getCodePage("1026");
	...
	public void testNewAndToolbox() {
		final CodePage cp = ToolboxCodePageProvider.getCodePage("1026");
		final CCSID1026 cpex = new CCSID1026();
		cpex.init();
		assertNotNull("At least an ASCII Codepage should be available.", cpex);

		// According to
		// http://www-01.ibm.com/software/globalization/cp/cp01026.jsp
	...
	public void testOldAndToolbox() {
		final CodePage cp = ToolboxCodePageProvider.getCodePage("1026");
		final CodePage cpex = CharMappings.getCodePage("1026");
		assertNotNull("At least an ASCII Codepage should be available.", cpex);
