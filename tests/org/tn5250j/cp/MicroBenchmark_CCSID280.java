 ...
 * of the 'old' CCSID280<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID280 {
	...
	private CodePage cp;
	private CCSID280 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("280");
		cpex = new CCSID280();
		cpex.init();
