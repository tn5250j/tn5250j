 ...
 * of the 'old' CCSID278<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID278 {
	...
	private CodePage cp;
	private CCSID278 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("278");
		cpex = new CCSID278();
		cpex.init();
