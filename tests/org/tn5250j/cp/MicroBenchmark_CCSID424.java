 ...
 * of the 'old' CCSID424<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID424 {
	...
	private CodePage cp;
	private CCSID424 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("424");
		cpex = new CCSID424();
		cpex.init();
