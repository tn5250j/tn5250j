 ...
 * of the 'old' CCSID285<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID285 {
	...
	private CodePage cp;
	private CCSID285 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("285");
		cpex = new CCSID285();
		cpex.init();
