 ...
 * of the 'old' CCSID297<->Unicode converte versus the new leaner one.
 * 
 * Result: The new implementation is much faster!
 * 
 * @author master_jaf
 */
public class MicroBenchmark_CCSID297 {
	...
	private CodePage cp;
	private CCSID297 cpex;	

	@Before
	public void setup() {
		cp = CharMappings.getCodePage("297");
		cpex = new CCSID297();
		cpex.init();
