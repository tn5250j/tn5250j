...
public class SpoolExportWizardSwingDemo {
    public static void main(final String[] args) {
        ...
        final SpoolExportWizardSwing panel = new SpoolExportWizardSwing(createSpoolFile(), gui);
        panel.setVisible(true);
    }

    private static SpooledFile createSpoolFile() {
        final Map<Integer, Object> attributes = new HashMap<>();
        attributes.put(SpooledFile.ATTR_PAGES, 71);
        return createSpoolFile(attributes);
    }
    private static SpooledFile createSpoolFile(final Map<Integer, Object> attributes) {
        final AS400 system = new AS400();
        final int number = 7;
