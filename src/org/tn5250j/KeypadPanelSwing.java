...
class KeypadPanelSwing extends JPanel {
    ...
    KeypadPanelSwing(final SessionConfig.SessionConfiguration sessionConfiguration) {
    ...
    public void updateButtonFontSize(float fontSize) {
        ...
        final Rectangle viewRect = referenceButton.getVisibleRect();

        final Insets i = referenceButton.getInsets();
        ...
        final String largestText = findLargestText();
    ...
    private JButton createButton(final KeyMnemonic mnemonic, final Insets noMargin, final CompoundBorder minimalBorder) {
    ...
    private void addInvisibleButtonsToPreventLayout(final JPanel bottomPanel) {
    ...
    void addActionListener(final Consumer<String> actionlistener) {
        for (final JButton button : buttons) {
            button.addActionListener(toActionListener(actionlistener));
        }
    }

    private ActionListener toActionListener(final Consumer<String> consumer) {
        return e -> consumer.accept(e.getActionCommand());
    }
