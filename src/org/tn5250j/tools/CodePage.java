...
public class CodePage {
   ...
   private static final char[] uni1025 = {
    ...
    private static final char[] uni1253 = {
      ...
      '\u00B0', '\u00B1', '\u00B2', '\u00B3' , '\u0384', '\u0385', '\u0386', '\u00B7',	/* 176 - 183  */
      '\u0388', '\u0389', '\u038A', '\u00BB' , '\u038C', '\u00BD', '\u038E', '\u038F',	/* 184 - 191  */
      '\u0390', '\u0391', '\u0392', '\u0393', '\u0394' , '\u0395', '\u0396', '\u0397', /* 192 - 199  */
      '\u0398', '\u0399', '\u039A', '\u039B', '\u039C' , '\u039D', '\u039E', '\u039F', /* 200 - 207  */
      '\u03A0', '\u03A1', '\u0147', '\u03A3', '\u03A4' , '\u03A5', '\u03A6', '\u03A7', /* 208 - 215  */
      '\u03A8', '\u03A9', '\u03AA', '\u03AB', '\u03AC' , '\u03AD', '\u03AE', '\u03AF', /* 216 - 223  */
      '\u03B0', '\u03B1', '\u03B2', '\u03B3', '\u03B4' , '\u03B5', '\u03B6', '\u03B7', /* 224 - 231  */
      '\u03B8', '\u03B9', '\u03BA', '\u03BB', '\u03BC' , '\u03BD', '\u03BE', '\u03BF', /* 232 - 239  */
      '\u03C0', '\u03C1', '\u03C2', '\u03C3', '\u03C4' , '\u03C5', '\u03C6', '\u03C7', /* 240 - 247  */
      '\u03C8', '\u03C9', '\u03C9', '\u03CA', '\u03CB' , '\u03CC', '\u03CD', '\u03CE', /* 248 - 255  */
   };

    private static final char[] uni1253g = {
    '\u0000','\u0001','\u0002','\u0003','\u0004','\u0005','\u0006','\u0007',
    '\b','\t','\n','\u000B','\f','\r','\u000E','\u000F',
    '\u0010','\u0011','\u0012','\u0013','\u0014','\u0015','\u0016','\u0017',
    '\u0018','\u0019','\u001A','\u001B','\u001C','\u001D','\u001E','\u001F',
...
//            System.out.println("using conversion");
             ...
             convert = true;
             //            System.out.println("using conversion");
         } else if(codePage.toLowerCase().startsWith("875")) {
             unicode = uni1253g;
             convert = true;
             //            System.out.println("using conversion");
         } else {
