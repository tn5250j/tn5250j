 ...
 */
abstract class AbstractAttributesPanelSwing extends JPanel implements AttributesPanel {
    ...
    public AbstractAttributesPanelSwing(final SessionConfig config) {
        this(config, "", nodePrefix);
    }

    public AbstractAttributesPanelSwing(final SessionConfig config, final String name) {
        this(config, name, nodePrefix);
    }

    public AbstractAttributesPanelSwing(final SessionConfig config, final String name, final String prefix) {
        super();
        changes = config;
