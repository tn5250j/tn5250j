...
public class SpoolExportWizard extends GenericTn5250JFrame implements WizardListener {
	...
	private JPanel spoolPanel = new JPanel();
	private JPanel spoolData = new JPanel();
	private JPanel spoolOptions = new JPanel();

	private JPanel destPanel = new JPanel();
	private JLabel labelSpooledFile = new JLabel();
	private JLabel spooledFile = new JLabel();
	private JLabel labelJobName = new JLabel();
	private JLabel jobName = new JLabel();
	private JLabel labelUser = new JLabel();
	private JLabel user = new JLabel();
	private JLabel labelNumber = new JLabel();
	private JLabel number = new JLabel();
	private JLabel labelFileNumber = new JLabel();
	private JLabel spooledFileNumber = new JLabel();
	private JLabel labelSystem = new JLabel();
	private JLabel systemName = new JLabel();
	private JLabel labelPages = new JLabel();
	private JLabel pages = new JLabel();

	private JComboBox cvtType;
	private JTextField pcPathInfo;
	private JTextField ifsPathInfo;
	private JButton pcSave;
	private JButton ifsSave;

	private JRadioButton pc;
	private JRadioButton ifs;
	...
	// Text Options
	private JCheckBox openAfter;
	private JTextField editor;
	private JButton getEditor;

	// Spooled File
	private SpooledFile splfile;

	// Session object
	private SessionGUI session;

	private JPanel twoPDF;
	private JPanel twoText;

	// Wizard
	private Wizard wizard;
	private WizardPage page;
	private WizardPage pagePDF;
	private WizardPage pageText;
	...
	private JPanel pageOne () throws Exception {
		...
		pages.setText(splfile.getIntegerAttribute(PrintObject.ATTR_PAGES).toString());
