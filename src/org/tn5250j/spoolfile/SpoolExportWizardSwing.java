 ...
 *
 */
public class SpoolExportWizardSwing extends GenericTn5250JFrameSwing implements WizardListener {
    ...
    //Construct the frame
    public SpoolExportWizardSwing(final SpooledFile splfile, final SessionGui session) {
