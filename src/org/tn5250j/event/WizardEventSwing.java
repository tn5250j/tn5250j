 ...
 */
public class WizardEventSwing extends java.util.EventObject {
    ...
    public WizardEventSwing(final Object source, final Component current_page, final Component new_page,
     ...
     * Sets the next page.
     */
    public void setNewPage(final Component p) {
        newPage = p;
    }
