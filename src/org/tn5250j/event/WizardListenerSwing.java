 ...
 */
public interface WizardListenerSwing {
     ...
     * last page.
     */
    public void nextBegin(WizardEventSwing e);

    /**
     * Invoked after advancing to the next page.
     */
    public void nextComplete(WizardEventSwing e);
     ...
     */
    public void previousBegin(WizardEventSwing e);

    /**
     * Invoked after advancing to the previous page.
     */
    public void previousComplete(WizardEventSwing e);

    /**
     * Invoked if a "finish" action is triggered.
     */
    public void finished(WizardEventSwing e);

    /**
     * Invoked if the Cancel action is triggered.
     */
    public void canceled(WizardEventSwing e);

    /**
     * Invoked if the Help action is triggered.
     */
    public void help(WizardEventSwing e);
